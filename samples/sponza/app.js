require([
	...
	function initialize() {
		...
		// get the camera
		var camera = engine.sceneGraph.find("name", "Camera", true).getComponent("Camera");
	...
	function setupUI() {
		...
		// get a few objects
		var c = engine.sceneGraph.find("name", "Camera", true).getComponent("Camera"),
			cc = engine.sceneGraph.find("name", "Camera", true).getComponent("CameraController"),
